	...
	<div class="mainArea">
		...
		<table align="center" id="inputArea">
			<tr>
				...
				<td width="350px" height="50px" colspan="2"><input type="text" class="form-control" id="name" placeholder="이름"></td>
			</tr>
			<tr>
				<td>*휴대전화번호</td>
				<td><input type="tel" class="form-control" id="phone" placeholder="휴대전화번호"></td>
			...
			<tr>
				<td>이메일</td>
				<td colspan="2"><input type="email" class="form-control" id="email" placeholder="이메일을 입력해주세요"></td>
			</tr>
			<tr>
				<td>이메일 확인</td>
