...
<!-- 	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' /> -->
	...
	<link rel="stylesheet" href="${ contextPath }/resources/assets/css/azzara.min.css">
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											<a href="#">
												<div class="notif-img">
													<img src="${ contextPath }/resources/assets/img/jm_denis.jpg" alt="Img Profile">
												</div>
												...
												<div class="notif-img">
													<img src="${ contextPath }/resources/assets/img/chadengle.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
												...
												<div class="notif-img">
													<img src="${ contextPath }/resources/assets/img/mlane.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
												...
												<div class="notif-img">
													<img src="${ contextPath }/resources/assets/img/talha.jpg" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<li>
									<div class="notif-center">
										<a href="#">
											...
											<div class="notif-img">
												<img src="${ contextPath }/resources/assets/img/profile2.jpg" alt="Img Profile">
											</div>
											<div class="notif-content">
						...
						<li class="nav-item dropdown hidden-caret"><a
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<li>
									<div class="user-box">
										<div class="avatar-lg">
											<img src="${ contextPath }/resources/assets/img/profile.jpg" alt="image profile"
...
<%-- 	<script src="${ contextPath }/resources/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js"></script>--%>
 <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
	...
	<!-- jQuery Scrollbar -->
	<script src="${ contextPath }/resources/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"></script>

	<!-- Moment JS -->
	<script src="${ contextPath }/resources/assets/js/plugin/moment/moment.min.js"></script>

	<!-- Chart JS -->
	<script src="${ contextPath }/resources/assets/js/plugin/chart.js/chart.min.js"></script>

	<!-- jQuery Sparkline -->
	<script src="${ contextPath }/resources/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

	<!-- Chart Circle -->
	<script src="${ contextPath }/resources/assets/js/plugin/chart-circle/circles.min.js"></script>

	<!-- Datatables -->
	<script src="${ contextPath }/resources/assets/js/plugin/datatables/datatables.min.js"></script>

	<!-- Bootstrap Notify -->
	<script src="${ contextPath }/resources/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

	<!-- Bootstrap Toggle -->
	<script src="${ contextPath }/resources/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js"></script>

	<!-- jQuery Vector Maps -->
	<script src="${ contextPath }/resources/assets/js/plugin/jqvmap/jquery.vmap.min.js"></script>
	<script src="${ contextPath }/resources/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>

	<!-- Google Maps Plugin -->
	<script src="${ contextPath }/resources/assets/js/plugin/gmaps/gmaps.js"></script>
