...
public class Attachment {
	...
	public Attachment(int fileId, String origineName, String changeName, String filePath, Date updateDate,
			...
			int homeNo, int childrenNo, int userNo, String albumchildrenNo) {
		super();
		this.fileId = fileId;
	...
	public String getAlbumchildrenNo() {
		return albumchildrenNo;
	}

	public void setAlbumchildrenNo(String albumchildrenNo) {
		this.albumchildrenNo = albumchildrenNo;
	}
	...
	public String toString() {
		return "Attachment [fileId=" + fileId + ", origineName=" + origineName + ", changeName=" + changeName
				...
				+ childrenNo + ", userNo=" + userNo + ", albumchildrenNo=" + albumchildrenNo + "]";
	}
